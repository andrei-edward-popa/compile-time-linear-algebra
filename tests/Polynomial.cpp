...
TEST(Degree, Three) {
	constexpr cte::poly::Polynomial poly{ 1.0l, -2.0l, 7.0l, -4.3l };
	constexpr std::size_t degree = poly.getDegree();
	constexpr std::size_t expected_degree = 3;
	EXPECT_EQ(degree, expected_degree);
}

TEST(Degree, Zero) {
	constexpr cte::poly::Polynomial poly{ -11.1l };
	constexpr std::size_t degree = poly.getDegree();
	constexpr std::size_t expected_degree = 0;
	EXPECT_EQ(degree, expected_degree);
}

TEST(Degree, NullPolynomial) {
	constexpr cte::poly::Polynomial poly{ 0.0l };
	constexpr std::size_t degree = poly.getDegree();
	constexpr std::size_t expected_degree = 0;
	EXPECT_EQ(degree, expected_degree);
}

TEST(Equality, DifferentDegree) {
	constexpr cte::poly::Polynomial poly1{ 1.0l, -2.0l, 3.0l, 4.0l };
	constexpr cte::poly::Polynomial poly2{ 3.0l, 2.1l, 7.2l, -4.0l, 1.1l, 3.3l };
	constexpr bool eq_result = poly1 == poly2;
	constexpr bool not_eq_result = poly1 != poly2;
	EXPECT_FALSE(eq_result);
	EXPECT_TRUE(not_eq_result);
}

TEST(Equality, NotEqualAndSameDegree) {
	constexpr cte::poly::Polynomial poly1{ 1.0l, -2.0l, 3.0l, 4.0l };
	constexpr cte::poly::Polynomial poly2{ 1.0l, 2.1l, 7.2l, -4.0l };
	constexpr bool eq_result = poly1 == poly2;
	constexpr bool not_eq_result = poly1 != poly2;
	EXPECT_FALSE(eq_result);
	EXPECT_TRUE(not_eq_result);
...
TEST(Equality, EqualAndSameDegree) {
	constexpr cte::poly::Polynomial poly1{ 1.0l, -2.0l, 3.0l, 4.0l };
	constexpr cte::poly::Polynomial poly2{ 1.0l, -2.0l, 3.0l, 4.0l };
	constexpr bool eq_result = poly1 == poly2;
	constexpr bool not_eq_result = poly1 != poly2;
...
TEST(PseudoAddition, SecondDegree) {
	constexpr cte::poly::Polynomial poly1{ 1.0l, -2.0l, 3.0l };
	constexpr cte::poly::Polynomial poly2{ 1.0l, -6.3l, 2.1l };
	constexpr cte::poly::Polynomial add_result = poly1 + poly2;
	constexpr cte::poly::Polynomial expected_result{ 2.0l, -8.3l, 5.1l };
	EXPECT_EQ(add_result, expected_result);
}

TEST(PseudoAddition, ZeroDegree) {
	constexpr cte::poly::Polynomial poly1{ 1.0l };
	constexpr cte::poly::Polynomial poly2{ -1.0l };
	constexpr cte::poly::Polynomial add_result = poly1 + poly2;
	constexpr cte::poly::Polynomial expected_result{ 0.0l };
	EXPECT_EQ(add_result, expected_result);
}


TEST(PseudoSubtraction, SecondDegree) {
	constexpr cte::poly::Polynomial poly1{ 4.0l, -2.0l, -3.0l };
	constexpr cte::poly::Polynomial poly2{ 1.0l, -6.3l, 2.1l };
	constexpr cte::poly::Polynomial sub_result = poly1 - poly2;
	constexpr cte::poly::Polynomial expected_result{ 3.0l, 4.3l, -5.1l };
	EXPECT_EQ(sub_result, expected_result);
}

TEST(PseudoSubtraction, ThirdDegree) {
	constexpr cte::poly::Polynomial poly1{ 4.0l, -2.0l, -3.0l, 2.2l };
	constexpr cte::poly::Polynomial poly2{ 4.0l, -2.0l, 3.1l, 6.3l };
	constexpr cte::poly::Polynomial sub_result = poly1 - poly2;
	constexpr cte::poly::Polynomial expected_result{ 0.0l, 0.0l, -6.1l, -4.1l };
	EXPECT_EQ(sub_result, expected_result);
}
/*
